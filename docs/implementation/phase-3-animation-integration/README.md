...
|---|---------|----------------|------------|--------|
| 3.1 | [PlayerController Animation-Anbindung](3.1-controller-binding.md) | `feat(phase-3): 3.1 PlayerController Animation-Anbindung` | `feat/animation-controller-binding` | [ ] |
